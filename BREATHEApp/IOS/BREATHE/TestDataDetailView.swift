    ...
    var body: some View{
        if let item = item {
            VStack {
                ...
                Spacer()
                List{
                    DetailedListItem(title: "Cockroach", abbr: "C", reading: item.reading_cockroach)
                    DetailedListItem(title: "Mouse", abbr: "M", reading: item.reading_mouse)
                    DetailedListItem(title: "Dust 1", abbr: "D1", reading: item.reading_dustmite1)
                    DetailedListItem(title: "Dust 2", abbr: "D2", reading: item.reading_dustmite2)
                }
